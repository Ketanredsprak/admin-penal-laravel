      ...
      <div class="error-wrapper maintenance-bg">
        <div class="container">
          ...
          <div class="maintenance-heading">
            <h2 class="headline">Under Development</h2>
          </div>
          <h4 class="sub-content">Our Site is Currently under development We will be back Shortly<br>Thank You For Patience</h4>
          <div><a class="btn btn-primary-gradien btn-lg text-light" href="{{ route('admin/login')}}">BACK TO HOME PAGE</a></div>
        </div>
      </div>
      <!-- Maintenance end-->
    </div>
